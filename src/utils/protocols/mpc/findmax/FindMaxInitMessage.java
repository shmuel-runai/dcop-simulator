...
/**
 * Initialization message for Secure FindMax protocol.
 * 
 * Broadcast by initiator to all agents to start the find-max operation.
 */
public class FindMaxInitMessage implements IProtocolMessage {
    ...
    public FindMaxInitMessage(String protocolId, String baseArrayId, int firstIndex, int lastIndex,
